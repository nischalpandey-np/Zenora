...
def admin_order_detail(order_id):
    try:
        ...
        return redirect(url_for('admin.admin_dashboard'))
# Update the admin_update_order function
@admin_bp.route('/admin_update_order', methods=['POST'])
@admin_required
def admin_update_order():
    try:
        ...
        valid_statuses = ['pending', 'approved', 'declined', 'processing', 'completed', 'cancelled']
        ...
        params = (
            new_status,
            decline_reason if new_status == 'declined' else None,
            admin_notes,
            order_id
        )
        ...
        logger.error(f"[admin_update_order ERROR] {str(e)}")
